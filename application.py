...
@application.route('/chooseOp')
def chooseOp():
    return render_template('chooseOp.html')
...
# @application.route('/anothertool', methods=['GET', 'POST'])
# def anothertool():
#     mode = 0o666
#     flags = os.O_RDWR | os.O_CREAT
#     os.system("python tonghop.py") #file.py is the script I'm trying to start
#     return "done"
